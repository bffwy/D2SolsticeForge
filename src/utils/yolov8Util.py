            ...
            for b in boxes:
                ...
                if class_item == float(1):
                    ...
                    if save:
                        ...
                        t = threading.Thread(target=result_save, args=(image, result, ts))
                        t.start()
                    return True
        return False
